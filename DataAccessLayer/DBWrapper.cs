...
namespace DataAccessLayer
{
    public class DBWrapper
    {
        ...
        public bool ExecuteSPWithoutBeginTrancaction(string sSP, Hashtable parameters)
        {
            bool IsSuccess = true;
        ...
        public bool ExecuteSP(string sSP, Hashtable parameters, ref long returnvalue)
        {
            bool IsSuccess = true;
            ...
            try
            {
                ...
                //get the treturn value
                returnvalue = (long)((SqlParameter)m_oCommand.Parameters[1]).Value;
